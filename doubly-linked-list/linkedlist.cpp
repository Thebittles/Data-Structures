...
//printlist
void LinkedList::printList(bool reverse){//default is false which means forward // true will go in reverse
   Node* current = head;
   if(current == nullptr){ // Dont think this is correct
      std::cout << "List is empty" << std::endl;
   }
   if(reverse){// traverse tail to head
    //Find the tail
      while (current->next != nullptr) {
         current = current->next;
      }
      //Traverse backwards and print data
      while (current != nullptr) {
